...
#
#
# Thanks to exavolt <exavolt@gmail.com>, the author of this module. We
# have downloaded this file from the following url:
#
#  * http://www.openwall.com/phpass/ (tarball)
#  * https://github.com/exavolt/python-phpass (git)
